...
# settings.py
ALLOWED_HOSTS = ['.render.com', 'your-service-name.onrender.com', 'localhost', '127.0.0.1']
CSRF_TRUSTED_ORIGINS = ['https://your-service-name.onrender.com'] # Используйте https!
