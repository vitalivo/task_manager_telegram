...
# --- НОВОЕ: Создание суперпользователя неинтерактивно ---
# ПРЕДУПРЕЖДЕНИЕ: Требует наличия DJANGO_SUPERUSER_USERNAME, DJANGO_SUPERUSER_EMAIL и DJANGO_SUPERUSER_PASSWORD
